  ...
  switch (config.branding.logo) {
    ...
    case 'custom':
      return config.branding.customLogoUrl ? (
        <Brand src={config.branding.customLogoUrl} alt={config.branding.name} style={{ height: '2rem' }} />
      ) : <OpenShiftLogo />
    default:
      return <OpenShiftLogo />
  }
...
function TmuxLogo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ height: '2rem', width: '2rem', color: '#3e8635' }}>
...
function RedHatLogo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 180" style={{ height: '2.5rem', width: 'auto', flexShrink: 0 }}>
...
function OpenShiftLogo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style={{ height: '2rem', width: '2rem', flexShrink: 0 }}>
